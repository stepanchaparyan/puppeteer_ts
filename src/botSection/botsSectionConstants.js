module.exports = {
	BOT_SECTION: {
		SELECTORS: {
			...
			CHECHBOX_MAGENTO: 'body > app-root > div > iox-page-container > div > iox-integrate > div > div > iox-cb-kind-item:nth-child(9) > div > div.switch.ng-star-inserted > input',
			...
			X_BUTTON_ON_GENERATE_KEY_ALERT: 'body > modal-container > div > div > div.modal-header > button > span',
