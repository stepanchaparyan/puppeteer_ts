module.exports = {
	BOT_SECTION: {
		SELECTORS: {
			...
			CHECHBOX_CHATBOT: 'body > app-root > div > iox-page-container > div > iox-integrate > div > div > iox-cb-kind-item:nth-child(1) > div > div.switch.ng-star-inserted > input',
			CHECHBOX_GOOGLE_HOME: '#ghome',
			CHECKBOX_MAGENTO: 'body > app-root > div > iox-page-container > div > iox-integrate > div > div > iox-cb-kind-item:nth-child(9) > div > div.switch.ng-star-inserted > input',
			API_CONNECTOR_SETTING_LINK_ON_ALERT: 'body > modal-container > div > div > div.modal-body.modal-body-magento > div.alert.alert-danger.keys-alert.ng-star-inserted > p > a',
			...
			GENERATE_KEY_BUTTON: 'body > modal-container > div > div > div.modal-body.modal-body-magento > div.loader-container > button',
			X_BUTTON_ON_GENERATE_KEY_ALERT: 'body > modal-container > div > div > div.modal-header > button',
			GENERATED_PRIVATE_KEY_TEXT: 'body > modal-container > div > div > div.modal-body.modal-body-magento > div.ng-star-inserted > div:nth-child(5) > textarea',
			ALERT_FOR_DELETE_INTEGRATED_BOT: 'body > modal-container > div > div > div > p',
			OK_BUTTON_ON_ALERT_FOR_DELETE_INTEGRATED_BOT: 'body > modal-container > div > div > div > div > button',
